import "./Hero.css";
import myImage from "../img/tomas-removebg-preview.png";
    ...
    <section id="hero" className="text-dark text-center text-lg-start bg-light">
      <div className="container">
        <div className="row justify-content-center" id="changerow">
          ...
          <div className="col-lg-6 col-md-6 " id="desc">
            <div className=" ">
              <h1 className="display-3 fw-bold lh-sm">
                Front-End React Developer
              </h1>
              <p id="">
                Hi, I'm Mohamed amine Mounir. A passionate Front-end React
                <br />
        ...
        <div id="skills">
          <p id="title-logos">Tech skills</p>
          <span id="logos">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="256"
